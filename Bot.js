...
vk.setOptions({
    token: '14431b9818065490a34d074f27d67a936d726a3102e1fb32bdc8066c49b6d07c3eb78820965e6b3920cf7', // токен группы
    apiMode: 'parallel',
	pollingGroupId: 190175362 // 1 замени на id группы 
});
...
vk.updates.use(async (message, next) => {  
    ...
    if(!uid[message.user]){
		...
		message.send(`🎉 ➾ *id${message.user}, вы успешно зарегистрировались!\n📝 ➾ "Помощь" - список команд.\n📝 ➾ Чтобы не пропустить обновление проекта вы должны быть подписаны на нашу группу: ${config.group_url}`)
